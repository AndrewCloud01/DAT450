...
//==============================================================================
const String PolyphonicSynthAudioProcessor::getName() const
{
...
const String PolyphonicSynthAudioProcessor::getProgramName (int index)
{
    return {};
}

void PolyphonicSynthAudioProcessor::changeProgramName (int index, const String& newName)
{
}
...
void PolyphonicSynthAudioProcessor::processBlock (AudioSampleBuffer& buffer, MidiBuffer& midiMessages)
{
...
AudioProcessorEditor* PolyphonicSynthAudioProcessor::createEditor()
{
    return new PolyphonicSynthAudioProcessorEditor (*this);
}

//==============================================================================
void PolyphonicSynthAudioProcessor::getStateInformation (MemoryBlock& destData)
{
